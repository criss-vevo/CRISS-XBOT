...
fredi({ nomCom: "crew", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
  const { arg, repondre, verifGroupe, msgRepondu, superUser, auteurMessage, auteurMsgRepondu } = commandeOptions;
...
fredi({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: 'ban', categorie: 'Mods' }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: 'bangroup', categorie: 'Mods' }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: 'onlyadmin', categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: 'sudo', categorie: 'Mods' }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: 'mention', categorie: 'Mods' }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: "save", aliases: ["send", "keep"], categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
fredi({ nomCom: "save2", aliases: ["send2", "keep2"], categorie: "Mods" }, async (dest, zk, commandeOptions) => {
