...
const { delay, loading, react } = require("../ezrah/utils");
...
// bug database
const { bugtext1 } = require("../ezrah/bugs/bugtext1");
const { bugtext2 } = require("../ezrah/bugs/bugtext2");
const { bugtext3 } = require("../ezrah/bugs/bugtext3");
const { bugtext4 } = require("../ezrah/bugs/bugtext4");
const { bugtext5 } = require("../ezrah/bugs/bugtext5");
const { bugtext6 } = require("../ezrah/bugs/bugtext6");
const { bugpdf } = require("../ezrah/bugs/bugpdf.js");
